...
- Refined the Max fee calculation in Smart Swaps to be no more than double the estimated gas fee ([#22127] (https://github.com/MetaMask/metamask-extension/pull/22127))
- Improved security and performance by updating the features responsible for password management and key handling ([#21878] (https://github.com/MetaMask/metamask-extension/pull/21878))
